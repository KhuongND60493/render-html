(self['webpackChunksas_dashboard'] = self['webpackChunksas_dashboard'] || []).push([["vendors-node_modules_pnpm_react-native_virtualized-lists_0_76_3__types_react_18_2_27_react-na-eccb7c"], {
"94971": (function (module, __unused_webpack_exports, __webpack_require__) {
"use strict";
/**
 ...
 *       strict-local
 */ 
var InteractionManager = (__webpack_require__(44963)/* .InteractionManager */.InteractionManager);
/**
...
"12203": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var CellRenderMask = /*#__PURE__*/ function() {
    ...
    _proto.addCells = function addCells(cells) {
        ...
        var _this__findRegion = _sliced_to_array(this._findRegion(cells.first), 2), firstIntersect = _this__findRegion[0], firstIntersectIdx = _this__findRegion[1];
        var _this__findRegion1 = _sliced_to_array(this._findRegion(cells.last), 2), lastIntersect = _this__findRegion1[0], lastIntersectIdx = _this__findRegion1[1];
        ...
        var newLeadRegion = [];
        var newTailRegion = [];
        var newMainRegion = _extends({}, cells, {
            isSpacer: false
        });
        ...
        var replacementRegions = _to_consumable_array(newLeadRegion).concat([
            newMainRegion
        ], _to_consumable_array(newTailRegion));
        var numRegionsToDelete = lastIntersectIdx - firstIntersectIdx + 1;
        (_this__regions = this._regions).splice.apply(_this__regions, [
            firstIntersectIdx,
            numRegionsToDelete
        ].concat(_to_consumable_array(replacementRegions)));
    };
...
"44130": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var _ListMetricsAggregator = /*#__PURE__*/ _interop_require_default(__webpack_require__(29509));
function _extends() {
    _extends = Object.assign || function(target) {
        for(var i = 1; i < arguments.length; i++){
            var source = arguments[i];
...
"29509": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var _VirtualizeUtils = __webpack_require__(73594);
var _invariant = /*#__PURE__*/ _interop_require_default(__webpack_require__(97250));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
...
"70705": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var StateSafePureComponent = /*#__PURE__*/ function(_React_PureComponent) {
    "use strict";
    _inherits(StateSafePureComponent, _React_PureComponent);
   ...
   */ _proto.recordInteraction = function recordInteraction() {
    ...
    _proto._onUpdateSync = function _onUpdateSync(props, viewableIndicesToCheck, onViewableItemsChanged, createViewToken) {
        ...
        for(var _i = 0; _i < nextItems.length; _i++){
            var _nextItems__i = _sliced_to_array(nextItems[_i], 2), key = _nextItems__i[0], viewable = _nextItems__i[1];
            if (!prevItems.has(key)) {
                changed.push(viewable);
            }
        }
        for(var _i1 = 0; _i1 < prevItems.length; _i1++){
            var _prevItems__i = _sliced_to_array(prevItems[_i1], 2), key1 = _prevItems__i[0], viewable1 = _prevItems__i[1];
            if (!nextItems.has(key1)) {
                changed.push(_extends({}, viewable1, {
                    isViewable: false
                }));
            }
        }
...
"73594": (function (__unused_webpack_module, exports) {
"use strict";
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
...
function computeWindowedRenderLimits(props, maxToRenderPerBatch, windowSize, prev, listMetrics, scrollMetrics) {
    ...
    var _elementsThatOverlapOffsets = _sliced_to_array(elementsThatOverlapOffsets([
        overscanBegin,
        visibleBegin,
        visibleEnd,
        overscanEnd
...
function keyExtractor(item, index) {
    if ((typeof item === "undefined" ? "undefined" : _type_of(item)) === 'object' && (item == null ? void 0 : item.key) != null) {
        return item.key;
    }
    if ((typeof item === "undefined" ? "undefined" : _type_of(item)) === 'object' && (item == null ? void 0 : item.id) != null) {
        return item.id;
    }
    return String(index);
}
...
var _Batchinator = /*#__PURE__*/ _interop_require_default(__webpack_require__(94971));
var _clamp = /*#__PURE__*/ _interop_require_default(__webpack_require__(4306));
var _infoLog = /*#__PURE__*/ _interop_require_default(__webpack_require__(46109));
var _CellRenderMask = __webpack_require__(12203);
var _ChildListCollection = /*#__PURE__*/ _interop_require_default(__webpack_require__(44130));
var _FillRateHelper = /*#__PURE__*/ _interop_require_default(__webpack_require__(35021));
var _ListMetricsAggregator = /*#__PURE__*/ _interop_require_default(__webpack_require__(29509));
var _StateSafePureComponent = /*#__PURE__*/ _interop_require_default(__webpack_require__(70705));
var _ViewabilityHelper = /*#__PURE__*/ _interop_require_default(__webpack_require__(14999));
var _VirtualizedListCellRenderer = /*#__PURE__*/ _interop_require_default(__webpack_require__(14394));
var _VirtualizedListContext = __webpack_require__(33553);
var _VirtualizedListProps = __webpack_require__(30901);
var _VirtualizeUtils = __webpack_require__(73594);
var _invariant = /*#__PURE__*/ _interop_require_default(__webpack_require__(97250));
 ...
 */ var VirtualizedList = /*#__PURE__*/ function(StateSafePureComponent) {
    "use strict";
    _inherits(VirtualizedList, StateSafePureComponent);
   ...
   * LTI update could not be added via codemod */ _this._defaultRenderScrollComponent = function(props) {
            ...
            if (_this._isNestedWithSameOrientation()) {
                ...
                var onContentSizeChange = props.onContentSizeChange, otherProps = _object_without_properties_loose(props, [
                    "onContentSizeChange"
                ]);
                return /*#__PURE__*/ (0, _jsxruntime.jsx)(_reactnative.View, _extends({}, otherProps));
            } else if (onRefresh) {
                ...
                /*#__PURE__*/ (0, _jsxruntime.jsx)(_reactnative.ScrollView, _extends({}, props, {
                ...
                // $FlowFixMe[incompatible-use]
                return /*#__PURE__*/ (0, _jsxruntime.jsx)(_reactnative.ScrollView, _extends({}, props));
            }
   ...
   */ _proto.getScrollResponder = function getScrollResponder() {
    ...
    _proto._pushCells = function _pushCells(cells, stickyHeaderIndices, stickyIndicesFromProps, first, last, inversionStyle) {
        var _this, _loop = function(ii) {
            ...
            cells.push(/*#__PURE__*/ (0, _jsxruntime.jsx)(_VirtualizedListCellRenderer.default, _extends({
    ...
    _proto.render = function render() {
            ...
            for(var _i = 0; _i < renderRegions.length; _i++){
                ...
                if (section.isSpacer) {
                    ...
                    cells.push(/*#__PURE__*/ (0, _jsxruntime.jsx)(_reactnative.View, {
                        style: _define_property({}, spacerKey, spacerSize)
        ...
        var scrollProps = _extends({}, this.props, {
            ...
            maintainVisibleContentPosition: this.props.maintainVisibleContentPosition != null ? _extends({}, this.props.maintainVisibleContentPosition, {
   ...
   */ _proto._maybeScrollToInitialScrollIndex = function _maybeScrollToInitialScrollIndex(contentWidth, contentHeight) {
    ...
    VirtualizedList._createRenderMask = function _createRenderMask(props, cellsAroundViewport, additionalRegions) {
        ...
        if (itemCount > 0) {
            var allRegions = [
                cellsAroundViewport
            ].concat(_to_consumable_array(additionalRegions != null ? additionalRegions : []));
...
"14394": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var _jsxruntime = __webpack_require__(31549);
var _ReactNativeFeatureFlags = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(33680));
var _VirtualizedListContext = __webpack_require__(33553);
var _invariant = /*#__PURE__*/ _interop_require_default(__webpack_require__(97250));
var _react = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(84816));
var _reactnative = __webpack_require__(44963);
...
var CellRenderer = /*#__PURE__*/ function(_React_PureComponent) {
    "use strict";
    _inherits(CellRenderer, _React_PureComponent);
    ...
    _proto.render = function render() {
        ...
        var itemSeparator = /*#__PURE__*/ _react.isValidElement(ItemSeparatorComponent) ? ItemSeparatorComponent : ItemSeparatorComponent && /*#__PURE__*/ (0, _jsxruntime.jsx)(ItemSeparatorComponent, _extends({}, this.state.separatorProps));
        ...
        var result = !CellRendererComponent ? /*#__PURE__*/ (0, _jsxruntime.jsxs)(_reactnative.View, _extends({
            style: cellStyle,
        ...
        })) : /*#__PURE__*/ (0, _jsxruntime.jsxs)(CellRendererComponent, _extends({
            cellKey: cellKey,
            index: index,
            item: item,
            style: cellStyle,
...
"33553": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function VirtualizedListCellContextProvider(param) {
    ...
    var context = (0, _react.useMemo)(function() {
        return currContext == null ? null : _extends({}, currContext, {
            cellKey: cellKey
        });
    }, [
        currContext,
...
"30901": (function (__unused_webpack_module, exports, __webpack_require__) {
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
var _jsxruntime = __webpack_require__(31549);
var _VirtualizedList = /*#__PURE__*/ _interop_require_default(__webpack_require__(36559));
var _VirtualizeUtils = __webpack_require__(73594);
var _invariant = /*#__PURE__*/ _interop_require_default(__webpack_require__(97250));
var _react = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(84816));
function _array_like_to_array(arr, len) {
 ...
 */ var VirtualizedSectionList = /*#__PURE__*/ function(_React_PureComponent) {
    "use strict";
    _inherits(VirtualizedSectionList, _React_PureComponent);
    ...
    _proto.render = function render() {
        ...
        return /*#__PURE__*/ (0, _jsxruntime.jsx)(_VirtualizedList.default, _extends({}, passThroughProps, {
...
function ItemWithSeparator(props) {
    ...
    var _React_useState = _sliced_to_array(_react.useState(false), 2), leadingSeparatorHiglighted = _React_useState[0], setLeadingSeparatorHighlighted = _React_useState[1];
    var _React_useState1 = _sliced_to_array(_react.useState(false), 2), separatorHighlighted = _React_useState1[0], setSeparatorHighlighted = _React_useState1[1];
    var _React_useState2 = _sliced_to_array(_react.useState({
    ...
    var _React_useState3 = _sliced_to_array(_react.useState({
        leadingItem: props.item,
        leadingSection: props.leadingSection,
        section: props.section,
        ...
        updateProps: function(select, newProps) {
            if (select === 'leading') {
                if (LeadingSeparatorComponent != null) {
                    setLeadingSeparatorProps(_extends({}, leadingSeparatorProps, newProps));
                } else if (prevCellKey != null) {
                    // update the previous item's separator
                    updatePropsFor(prevCellKey, _extends({}, leadingSeparatorProps, newProps));
                }
            } else if (select === 'trailing' && SeparatorComponent != null) {
                setSeparatorProps(_extends({}, separatorProps, newProps));
            }
        }
    };
    ...
    var leadingSeparator = LeadingSeparatorComponent != null && /*#__PURE__*/ (0, _jsxruntime.jsx)(LeadingSeparatorComponent, _extends({
        highlighted: leadingSeparatorHiglighted
    }, leadingSeparatorProps));
    var separator = SeparatorComponent != null && /*#__PURE__*/ (0, _jsxruntime.jsx)(SeparatorComponent, _extends({
...
"41005": (function (module, exports, __webpack_require__) {
"use strict";
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
...
__webpack_require__(33553);
var _VirtualizeUtils = __webpack_require__(73594);
module.exports = {
    keyExtractor: _VirtualizeUtils.keyExtractor,
    get VirtualizedList () {
        return __webpack_require__(36559);
    },
    get VirtualizedSectionList () {
        return __webpack_require__(9781);
    },
    get VirtualizedListContextResetter () {
        var VirtualizedListContext = __webpack_require__(33553);
        return VirtualizedListContext.VirtualizedListContextResetter;
    },
    get ViewabilityHelper () {
        return __webpack_require__(14999);
    },
    get FillRateHelper () {
        return __webpack_require__(35021);
    }
};
...
}]);//# sourceMappingURL=vendors-node_modules_pnpm_react-native_virtualized-lists_0_76_3__types_react_18_2_27_react-na-eccb7c.chunk.bundle.map?platform=android